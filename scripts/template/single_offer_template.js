                    ...
                    <div class="d_flex_cc_gl f_d_r_resp_c">
                        ...
                        <div class="d_flex_cs_gm f_d_c ">
                            <div class="d_flex_cs_gm f_d_r_resp_c">
                                ...
                                })">${currentSingleOfferUser.first_name} ${currentSingleOfferUser.last_name}</h3>
...
function getSingleOfferDetailTemplate() {
  ...
  let button = "";
  if (currentSingleOfferUser.type == "customer") {
    button = `<button onclick="openDialog('order_dialog')" class="std_btn btn_prime pad_s">Bestellen</button>`;
  }
  button = `<button onclick="openDialog('order_dialog')" class="std_btn btn_prime pad_s">Bestellen</button>`;
  return (
    `
